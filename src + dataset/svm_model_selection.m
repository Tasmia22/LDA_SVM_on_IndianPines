...
for cVal = cMinValue : 1 : cMaxValue
   ...
   for sigmaVal = sigmaMinValue : 0.10 : sigmaMaxValue
      ...
      for i=1:size(uniqueClass,1)
          ...
          svmStruct(i) = svmtrain(trainDataLDA,groups,'Method','SMO','SMO_Opts',opts,'BoxConstraint', actualC, 'Kernel_Function','rbf', 'RBF_Sigma', actualSigma,'KernelCacheLimit',10000);
      end
